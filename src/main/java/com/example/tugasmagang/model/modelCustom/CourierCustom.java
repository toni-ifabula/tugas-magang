package com.example.tugasmagang.model.modelCustom;

import javax.persistence.*;

public class CourierCustom {

    private int courier_id, coverage_city;
    private String courier_name, courier_type;

    public CourierCustom(int courier_id, int coverage_city, String courier_name, String courier_type) {
